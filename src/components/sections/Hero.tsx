...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen pt-24 pb-16 flex flex-col justify-center relative bg-gradient-to-br from-slate-50 to-slate-100"
    >
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="mb-10 animate-fade-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-4 text-slate-800">
              Muhammad Salman
            </h1>
            <h2 className="text-xl md:text-2xl font-heading text-primary mb-6">
              Software Engineer | Computer Vision Enthusiast
            </h2>
            <p className="text-lg max-w-lg mx-auto mb-8 text-slate-600">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce hidden md:block">
        <a 
          href="#about" 
          className="flex flex-col items-center text-sm font-medium text-slate-600"
        >
